...
const SupportChatbot = ({ onEscalateToEmail, onClose }: SupportChatbotProps) => {
  ...
  const botResponses: Record<string, string> = {
    ...
    "embed": "Once your chatbot is ready, you'll get a simple HTML code snippet. Just copy and paste it into your website - no technical knowledge required!",
    "website": "Once your chatbot is ready, you'll get a simple HTML code snippet. Just copy and paste it into your website - no technical knowledge required!",
    "integrate": "Once your chatbot is ready, you'll get a simple HTML code snippet. Just copy and paste it into your website - no technical knowledge required!",
  ...
  const findBestResponse = (userMessage: string): string => {
    ...
    const categories: { key: string; keywords: string[] }[] = [
      ...
      { key: "embed", keywords: ["embed","integration","integrate","website","script","snippet"] },
